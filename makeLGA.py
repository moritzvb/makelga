# Copyright 2013 Moritz v. Buttlar
#
...
strout+='<!-- Created with makeLGA.py  -->\n';
...
sx4=sx3;
sy4=sy1;
strout+=' <line  stroke="white" stroke-linecap="round" x1='+sx1+' y1='+sy1+' x2='+sx2+' y2='+sy2+'  stroke-width="0.576" x2="0"/>\n';
strout+=' <line  stroke="white" stroke-linecap="round" x1='+sx2+' y1='+sy2+' x2='+sx3+' y2='+sy3+'  stroke-width="0.576" x2="0"/>\n';
...
for i in range(x):
 for j in range(y):
    ...
    str_out+=yname[j]+str(i+1)+'pad" stroke-width="0"/> \n'; 
